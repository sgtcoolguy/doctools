...
var withThis = ['<h1>','</h1>','<h2>','</h2>','<h2>','</h2>','<li>','</li>','<p>','<h3','</h3>','<h4','</h4>','<div>','<div>','','','','','','','</p>','</li>','','','<ul','','','','','','<th  class="confluenceTh"','<li>','<ul>','','','<h3>','</h3>','','','','','<code class="indent3">','<code class="indent2">','<code class="indent1">','','<code class="indent1">','<code></code>','<code class="indent2">','<code class="indent3">','','<h3>','<li>','<p>','<p>','<li>'];
