...
var replaceThis = ['<h2 class="heading "><span>','</span></h2>','<h3 class="heading ">','</h3>','<h2><span>','</span></h2>','<li class=" ">    <p  >','</p>\n</li>','<p  >','<h4','</h4>','<h5','</h5>','<div xmlns="http://www.w3.org/1999/xhtml" class="confbox programlisting scroll-unprocessed">','<div class="defaultnew syntaxhighlighter">',' class="plain"',' class="line"',' class="value"',' class="external-link external-link"',' class="section section-3 "',' class=" "','    </p>','    </li>',' class="toc-indentation "','  class="document-link "','</p>\n<ul',' class="section section-4 "',' class="section section-5 "',' class="heading "',' class="comments"',' class="keyword"','<td  class="confluenceTh"','<li class="li1 ">    <p>','</p>\n<ul>','    <p  class="p1">',' class="section section-2 "','<h3><span>','</span></h3>','  class="confluenceTh" rowspan="1" colspan="1"','  class="confluenceTd" rowspan="1" colspan="1"',' class="confluenceTable"','</code><code>','<code>            &lt;','<code>        &lt;','<code>    &lt;','</code><code class="string">','<code>    ','<code>Â </code>','<code class="indent1">    ','<code class="indent2">    ','<h1></h1>','<h3 class="heading li3"><span>','<li class="li3 ">','<p class="li1">','<p class="gh-header-title">','<li class="p2 ">','<code>  '];
var withThis = ['<h1>','</h1>','<h2>','</h2>','<h2>','</h2>','<li>','</li>','<p>','<h3','</h3>','<h4','</h4>','<div>','<div>','','','','','','','</p>','</li>','','','<ul','','','','','','<th  class="confluenceTh"','<li>','<ul>','','','<h3>','</h3>','','','','','<code class="indent3">','<code class="indent2">','<code class="indent1">','','<code class="indent1">','<code></code>','<code class="indent2">','<code class="indent3">','','<h3>','<li>','<p>','<p>','<li>','<code class="indent1">'];
