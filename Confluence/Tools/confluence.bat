...
rem   java -jar "%dirPath%"/lib/confluence-cli-5.1.0.jar --server https://my.example.com --user automation --password automation %*

java -jar "%dirPath%"/lib/confluence-cli-5.1.0.jar %*
